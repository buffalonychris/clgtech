...
(async function(){
  const head = await fetch('/clgtech/theme/components/header.html').then(r=>r.text()).catch(()=>''),
        foot = await fetch('/clgtech/theme/components/footer.html').then(r=>r.text()).catch(()=>''),
